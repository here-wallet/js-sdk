...
import { AsyncHereSignResult } from "./strategy";
...
export declare const createRequest: (config: HereConfiguration, request: string, options: Record<string, string>) => Promise<any>;
